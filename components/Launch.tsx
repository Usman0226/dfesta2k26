...
const Launch = ({ onComplete }: { onComplete?: () => void }) => {
    return (
        <motion.div
        ...
        >
            ...
            <h1 aria-label="Data Science" className="leading-none mb-1">
                ...
                <motion.span
                    ...
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    transition={{ duration: 0.01, delay: 1.15 }}
                >
                    <DataScramble
                        text="DATA"
                        baseDelay={1.15}
                        iterationsPerChar={16}
                        intervalMs={50}
                        staggerMs={75}
                    />
                </motion.span>
            ...
            {/* "Presents" bridge text */}
            <motion.p
                variants={fadeUp(2.2)}
                className="text-[11px] md:text-xs tracking-[0.55em] uppercase text-zinc-400 mt-3 mb-0"
                style={{ fontFamily: "var(--font-display)", fontStyle: "italic" }}
            >
                Presents
            </motion.p>

            {/* Divider — fires onComplete when it finishes expanding */}
            <motion.div
                variants={fadeUp(2.45)}
            ...
            >
                <motion.span
                    ...
                    animate={{ scaleX: 1 }}
                    transition={{ delay: 2.65, duration: 0.6, ease: EASE }}
